...
//     `https://efmsapi.azurewebsites.net/api/Jobs/getAllJobsByCompany?name=${searchQuery}&companyId=${companyId}&jobCategoryId=${jobCategoryId}`
//   );
...
console.log("companyObj", companyObj);
  ...
  // const { data, isLoading, error } = useFetch(
  //   `https://efmsapi.azurewebsites.net/api/Jobs/getAllJobsByCompany?name=${searchQuery}&companyId=${companyId}&jobCategoryId=${storedCategoryId}`
  // );

  useEffect(() => {
    setIsLoading(true)
    const fetchData = async () => {
        const url = `https://efmsapi.azurewebsites.net/api/Jobs/getAllJobsByCompany?name=${searchQuery}&companyId=${companyId}&jobCategoryId=${jobCategoryId}`;
        try {
