...
function JobCategory() {
  const { data: jobCategory } = useFetch(
    "https://efmsapi.azurewebsites.net/api/JobsCategory/getAllJobsCategories"
  );
  ...
  const handleDelete = async (companyId) => {
    ...
    try {
      const response = await fetch(
        `https://efmsapi.azurewebsites.net/api/JobsCategory/deleteJobsCategory?id=${companyId}`,
        {
          method: "PUT",
          headers: {
          ...
          <div className="showFormFixed">
            <div className="showFormFixedScroll">
              <EditEntity
                ...
                apiEndpoint="https://efmsapi.azurewebsites.net/api/JobsCategory/updateJobsCategory"
