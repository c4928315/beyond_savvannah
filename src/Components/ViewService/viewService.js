...
function ViewService() {
  ...
  const cost = "8000"
  const service = "ATS CV Revamp"
  const duration = "N/A"
  const description = "Navigating the Applicant Tracking System (ATS) is crucial in today's competitive job market, and we're here to help you excel. Our comprehensive package includes an ATS-compliant CV and a precision-crafted ATS-compliant cover letter, tailored to your specific job application needs."
