...
function ViewStudentPack() {
  ...
  const cost = "5000"
  const service = "Students Package"
  const duration = "N/A"
  const description = "Unlock the full potential of your job search with our tailored CV review and cover letter services. This package is designed to empower you in your career journey by ensuring your application materials stand out to potential employers."
