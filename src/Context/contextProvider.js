...
export const LocalProvider = ({ children }) => {
  ...
  const { data, isLoading, error } = useFetch(
    `https://efmsapi.azurewebsites.net/api/Jobs/getAllJobsByCompany?jobCategoryId=${jobCategoryId}`
  );
  ...
  const {
    ...
    "https://efmsapi.azurewebsites.net/api/Companies/getAllCompanies"
  );

  const { data: category } = useFetch("https://efmsapi.azurewebsites.net/api/JobsCategory/getJobsCategoriesDropDown");
